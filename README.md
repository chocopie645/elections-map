...
```
(*side note*) In order to simplify the visualisation process, I removed data regarding votes for the independent senate candidate, blank votes, and votes titled "all other". Treating the race as a purely bipartisan and only looking at the subset of people who voted for Warren or Diehl race and not the independent candidate obviously does not give us the full picture, but the median percentage of votes that didn't go to these two candidates per town is 5.2% so we can still gain us a general picture of voting patterns.
